...
const listar = async (req, res) => {
  try {
    ...
    res.status(500).json({ message: "Error al listar stock", error: error.message });
  }
};
...
const crear = async (req, res) => {
  try {
    ...
    res.status(400).json({ message: "Error al crear stock", error: error.message });
  }
};
...
const eliminar = async (req, res) => {
  try {
    ...
    res.status(400).json({ message: "Error al eliminar stock", error: error.message });
  }
};
